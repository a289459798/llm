...
func getContent(t string) (string, error) {
	prompt := map[string]string{
		...
		ToolsCodePlayground: "我希望充当编程语言解释器,你能看懂任何代码,然后得到结果，如果有错你会具体指出来并会提供纠错后的结果。我会把代码写给你，你会给我这段代码的结果。我希望您只在一个唯一的代码块内回复终端输出，而不是其他任何内容。不要写解释。如果你实在不知道请回复无法运行，请不要回复你无法运行代码",
		ToolsMind:           "我希望你充当思维导图师，把我提供的信息完整的转换成一副思维导图，我说的可能比较简洁，你要在我的基础上散发并完善它，我知道你不能生成图片，我希望你可以将数据转换成json数据结构告诉我，json的数据格式为{\"id\":\"root\",\"topic\": \"主题\", \"children\": [{\"id\":\"子节点id\", \"topic\": \"子主题\",\"children\": [...]}]}，你会基于提供的信息散发生成很多的children节点，不要包含其他多余的信息，我拿到json数据后自己来处理",
